...
class MultiModalDataset(Dataset):
    def __init__(self, data_dir, patient_ids, inf_wsi_features, clinical_scaler=None, rna_scaler=None, max_wsi_patches=20000):
        self.patient_ids = patient_ids
        self.data_dir = data_dir
        self.max_wsi_patches = max_wsi_patches
        self.inf_wsi_patches =  inf_wsi_features
    ...
    def __getitem__(self, idx):
        ...
        wsi_features_file = os.path.join(self.inf_wsi_patches, f"{patient_id}_HE.pt")
